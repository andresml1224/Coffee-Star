<?php
  ...
  $doc=$_GET['doc'];
  $query="SELECT * FROM empleados WHERE idEmpleados =$doc";
...
<body>
    ...
    <div class="col-lg-6">
        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
            <h1 class="text-white mb-4 mt-5">Actualizar empleado</h1>
            <form class="mb-5" action="EmpleadoActualizar.php" method="post">
                ...
                <div class="form-group">
                    <h2 class="text-primary font-weight-medium m-0">Ingrese su cargo</h2>
                    <input type="text" class="form-control" name="Cargo" value="<?php echo $vec[2] ?>"
                        required="required" />
                </div>
                <div class="form-group">
                    <h2 class="text-primary font-weight-medium m-0">Ingrese su correo</h2>
                    <input type="email" class="form-control" name="Correo" value="<?php echo $vec[3] ?>"
                        required="required" />
                </div>
                <div class="form-group">
