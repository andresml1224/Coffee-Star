<?php
    ...
    $query = "SELECT IdProducto, Nombre, Tipo from productos";
    $Consulta = mysqli_query($conn, $query)
    
?>
<?php
    $query2 = "SELECT idPedido, Mesa from pedido";
...
<?php
    ...
    <div class="col-lg-6">
        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
            ...
            <form class="mb-5" action="ventaRegistro.php" method="post">
                <div class="form-group">
                    <h2 class="text-primary font-weight-medium m-0">Ingrese el id de la venta</h2>
                    <input type="number" class="form-control" name="idVenta" value="<?php echo $vec[0] ?>"
                        required="required" />
                </div>
                <div class="form-group">
                <h2 class="text-primary font-weight-medium m-0">Ingrese el producto que genero esta venta</h2>
                    <select class="custom-select bg-transparent border-primary px-4" style="height: 49px;" name="Producto" value="<?php echo $vec[1] ?>">
                    <option><?php
                ...
                <div class="form-group">
                <h2 class="text-primary font-weight-medium m-0">Ingrese el pedido de esta venta</h2>
                    <select class="custom-select bg-transparent border-primary px-4" style="height: 49px;" name="Pedido" value="<?php echo $vec[2] ?>">
                    <option><?php
