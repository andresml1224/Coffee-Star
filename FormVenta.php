        ...
        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
            ...
            <form class="mb-5" action="ventaRegistro.php" method="post">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="idVenta" 
                        required="required" />
                </div>
                <div class="form-group">
                <h2 class="text-primary font-weight-medium m-0">Ingrese el producto que genero esta venta</h2>
                    <select class="custom-select bg-transparent border-primary px-4" style="height: 49px;" name="Producto">
                    <option><?php
                ...
                <h2 class="text-primary font-weight-medium m-0">Ingrese el pedido de esta venta</h2>
                    <select class="custom-select bg-transparent border-primary px-4" style="height: 49px;" name="Pedido">
                    <option><?php
