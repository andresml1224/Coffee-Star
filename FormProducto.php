...
<?php
    ...
    <div class="col-lg-6">
        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
            <h1 class="text-white mb-4 mt-5">Actualizar productos</h1>
            <form class="mb-5" action="productoRegistro.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" style="height: 49px;" name="Tipo">
