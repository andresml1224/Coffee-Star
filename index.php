        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 py-0 py-lg-5" style="text-align: center;">
                    <h1 class="mb-3">Somos un cafe-bar nueva con una oferta</h1>
                    <h5 class="mb-3">Estamos enfocados en atender de manera presencial y virtual para personas que desean reclamar algun pedido</p>
                </div>
            </div>
        </div>
    </div>
