...
<fieldset>
    ...
    <table class= "table">
        ...
        <?php
            ...
            $mostrar = "SELECT * FROM clientes WHERE CedulaCliente LIKE '$Buscar' or Nombre LIKE '$Buscar' or Correo LIKE '$Buscar'";
                ...
                if (mysqli_num_rows($resultado)>0){
                    ...
                    while ($vec= mysqli_fetch_array($resultado)) {?>
                        <tr>
                            ...
                            <td>
                                <a href='ActClienteForm.php?doc=<?php echo $vec[0]?>'><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href='EliminarCliente.php?doc=<?php echo $vec[0]?>'><i class="fa-duotone fa-trash"></i></a>
                            </td>
                        </tr>
        <?php 
                    }
