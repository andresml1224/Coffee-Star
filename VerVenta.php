...
<fieldset>
    ...
    <table class= "table">
        ...
        $mostrar = "SELECT * FROM productos WHERE IdVenta LIKE '$Buscar' or Productos_IdProducto LIKE '$Buscar' or Pedido_IdPedido LIKE '$Buscar'
        LIKE '$Buscar'";
        ...
        while ($vec= mysqli_fetch_array($resultado)) {?>
            <tr>
                ...
                <td>
                    <a href='ActVentaForm.php?doc=<?php echo $vec[0]?>'><i class="fa-solid fa-pen-to-square"></i></a>
                    <a href='EliminarVenta.php?doc=<?php echo $vec[0]?>'><i class="fa-duotone fa-trash"></i></a>
                </td>
            </tr>
