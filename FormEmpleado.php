...
<?php
    ...
    <div class="col-lg-6">
        <div class="text-center p-5" style="background: rgba(51, 33, 29, .8);">
            <h1 class="text-white mb-4 mt-5">Registro empleados</h1>
            <form class="mb-5" action="empleadoRegistro.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" style="height: 49px;" name="Cargo">
                ...
                <div class="form-group">
                    <h2 class="text-primary font-weight-medium m-0">Ingrese su clave</h2>
